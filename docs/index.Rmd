...
###  1.5.2 Undersampling - Near Miss Algorithm  (US_NEARMISS)
...
###  1.5.3 Undersampling - Tomek Links  (US_TOMEK)
...
###  1.5.4 Oversampling - Adaptive Synthetic Algorithm (OS_ADASYN)
...
###  1.5.5 Oversampling - Borderline Synthetic Minority Oversampling Technique  (OS_BSMOTE)
...
###  1.5.6 Oversampling - Synthetic Minority Oversampling Technique  (OS_SMOTE)
...
###  1.5.7 Oversampling - Random Oversampling Examples  (OS_ROSE)
