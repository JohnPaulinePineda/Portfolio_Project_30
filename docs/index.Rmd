...
|      **[A.2]** <span style="color: #FF0000">V11</span> variable (numeric)
|
...
LR_Model_Predictions %>%
  ...
  ylab("Estimated Rock Object Detection Probability") +
  labs(color = "Class") +
  ...
  ggtitle("Estimated Rock Object Detection Probabilities Based on Classification Index : Logistic Regression") +
  theme_bw() +
...
##################################
# Verifying the class distribution
# for the upsampled data using OS_ADASYN
##################################
...
LR_OS_ADASYN_Model_Predictions %>%
  ...
  scale_x_continuous( limits=c(-10,5), breaks=seq(-10,5,by=1)) +
  scale_y_continuous( limits=c(0,1), breaks=seq(0,1,by=0.1),labels = scales::percent) +
  ggtitle("Estimated Rock Object Detection Probabilities Based on Classification Index : Logistic Regression (OS_ADASYN)") +
  theme_bw() +
  theme(plot.title = element_text(color="black", size=14, face="bold", hjust=0.50),
        axis.title.x = element_text(color="black", size=12, face="bold"),
        axis.title.y = element_text(color="black", size=12, face="bold"),
...
##################################
# Verifying the class distribution
# for the upsampled data using OS_BSMOTE
##################################
...
LR_OS_BSMOTE_Model_Predictions %>%
  ...
  scale_x_continuous( limits=c(-10,5), breaks=seq(-10,5,by=1)) +
  scale_y_continuous( limits=c(0,1), breaks=seq(0,1,by=0.1),labels = scales::percent) +
  ggtitle("Estimated Rock Object Detection Probabilities Based on Classification Index : Logistic Regression (OS_BSMOTE)") +
  theme_bw() +
  theme(plot.title = element_text(color="black", size=14, face="bold", hjust=0.50),
        axis.title.x = element_text(color="black", size=12, face="bold"),
        axis.title.y = element_text(color="black", size=12, face="bold"),
...
##################################
# Verifying the class distribution
# for the upsampled data using OS_SMOTE
##################################
...
LR_OS_SMOTE_Model_Predictions %>%
  ...
  scale_x_continuous( limits=c(-10,5), breaks=seq(-10,5,by=1)) +
  scale_y_continuous( limits=c(0,1), breaks=seq(0,1,by=0.1),labels = scales::percent) +
  ggtitle("Estimated Rock Object Detection Probabilities Based on Classification Index : Logistic Regression (OS_SMOTE)") +
  theme_bw() +
  theme(plot.title = element_text(color="black", size=14, face="bold", hjust=0.50),
        axis.title.x = element_text(color="black", size=12, face="bold"),
        axis.title.y = element_text(color="black", size=12, face="bold"),
...
##################################
# Verifying the class distribution
# for the upsampled data using OS_ROSE
##################################
...
LR_OS_ROSE_Model_Predictions %>%
  ...
  scale_x_continuous( limits=c(-10,5), breaks=seq(-10,5,by=1)) +
  scale_y_continuous( limits=c(0,1), breaks=seq(0,1,by=0.1),labels = scales::percent) +
  ggtitle("Estimated Rock Object Detection Probabilities Based on Classification Index : Logistic Regression (OS_ROSE)") +
  theme_bw() +
  theme(plot.title = element_text(color="black", size=14, face="bold", hjust=0.50),
        axis.title.x = element_text(color="black", size=12, face="bold"),
        axis.title.y = element_text(color="black", size=12, face="bold"),
...
OS_NEARMISS <- recipe(Class ~ V1 + V11, data = PMA_PreModelling_Train) %>%
  step_nearmiss(Class, seed=123456789) %>%
  prep()

PMA_PreModelling_Train_LR_OS_NEARMISS <- OS_NEARMISS %>%
bake(new_data = NULL)

(PMA_PreModelling_Train_LR_OS_NEARMISS <- as.data.frame(PMA_PreModelling_Train_LR_OS_NEARMISS))

##################################
# Verifying the class distribution
# for the upsampled data using OS_NEARMISS
##################################
table(PMA_PreModelling_Train_LR_OS_NEARMISS$Class) 

##################################
# Formulating the structure of the
# Logistic Regression model
##################################
LR_OS_NEARMISS_Model <- glm(Class ~ V1 + V11,
                data = PMA_PreModelling_Train_LR_OS_NEARMISS,
                family = binomial)

##################################
# Consolidating the model results
##################################
summary(LR_OS_NEARMISS_Model)

LR_OS_NEARMISS_Model_Coef <- (as.data.frame(LR_OS_NEARMISS_Model$coefficients))
LR_OS_NEARMISS_Model_Coef$Coef <- rownames(LR_OS_NEARMISS_Model_Coef)
LR_OS_NEARMISS_Model_Coef$Model <- rep("LR_OS_NEARMISS",nrow(LR_OS_NEARMISS_Model_Coef))
colnames(LR_OS_NEARMISS_Model_Coef) <- c("Estimates","Coefficients","Model")
print(LR_OS_NEARMISS_Model_Coef, rownames=FALSE)

##################################
# Computing the model predictions
##################################
(LR_OS_NEARMISS_Model_Probabilities <- predict(LR_OS_NEARMISS_Model, 
                              type = c("response")))
...
# based from the model predictions
##################################
(LR_OS_NEARMISS_Model_Indices <- predict(LR_OS_NEARMISS_Model, 
                           type = c("link")))
max(LR_OS_NEARMISS_Model_Indices)
min(LR_OS_NEARMISS_Model_Indices)
...
# based from the model predictions
##################################
LR_OS_NEARMISS_Model_Predictions <- as.data.frame(PMA_PreModelling_Train_LR_OS_NEARMISS)
LR_OS_NEARMISS_Model_Predictions$LR_OS_NEARMISS_Prob <- LR_OS_NEARMISS_Model_Probabilities
LR_OS_NEARMISS_Model_Predictions$LR_OS_NEARMISS_LP <- LR_OS_NEARMISS_Model_Indices
LR_OS_NEARMISS_Model_Predictions$Class <- as.factor(LR_OS_NEARMISS_Model_Predictions$Class)
LR_OS_NEARMISS_Model_Predictions$Label <- rep("LR_OS_NEARMISS",nrow(LR_OS_NEARMISS_Model_Predictions))

##################################
# Formulating the probability curve
# using the consolidated model predictions
##################################
LR_OS_NEARMISS_Model_Predictions %>%
  ggplot(aes(x = LR_OS_NEARMISS_LP ,
             y = LR_OS_NEARMISS_Prob,
             color = Class)) +
  scale_colour_manual(values=c("#1846BA55","#B8000055")) +
  geom_point(size=5) +
  geom_line(color="black") +
  ...
  scale_x_continuous( limits=c(-10,5), breaks=seq(-10,5,by=1)) +
  scale_y_continuous( limits=c(0,1), breaks=seq(0,1,by=0.1),labels = scales::percent) +
  ggtitle("Estimated Rock Object Detection Probabilities Based on Classification Index : Logistic Regression (OS_NEARMISS)") +
  theme_bw() +
  theme(plot.title = element_text(color="black", size=14, face="bold", hjust=0.50),
        axis.title.x = element_text(color="black", size=12, face="bold"),
        axis.title.y = element_text(color="black", size=12, face="bold"),
...
OS_TOMEK <- recipe(Class ~ V1 + V11, data = PMA_PreModelling_Train) %>%
  step_tomek(Class, seed=123456789) %>%
  prep()

PMA_PreModelling_Train_LR_OS_TOMEK <- OS_TOMEK %>%
bake(new_data = NULL)

(PMA_PreModelling_Train_LR_OS_TOMEK <- as.data.frame(PMA_PreModelling_Train_LR_OS_TOMEK))

##################################
# Verifying the class distribution
# for the upsampled data using OS_TOMEK
##################################
table(PMA_PreModelling_Train_LR_OS_TOMEK$Class) 

##################################
# Formulating the structure of the
# Logistic Regression model
##################################
LR_OS_TOMEK_Model <- glm(Class ~ V1 + V11,
                data = PMA_PreModelling_Train_LR_OS_TOMEK,
                family = binomial)

##################################
# Consolidating the model results
##################################
summary(LR_OS_TOMEK_Model)

LR_OS_TOMEK_Model_Coef <- (as.data.frame(LR_OS_TOMEK_Model$coefficients))
LR_OS_TOMEK_Model_Coef$Coef <- rownames(LR_OS_TOMEK_Model_Coef)
LR_OS_TOMEK_Model_Coef$Model <- rep("LR_OS_TOMEK",nrow(LR_OS_TOMEK_Model_Coef))
colnames(LR_OS_TOMEK_Model_Coef) <- c("Estimates","Coefficients","Model")
print(LR_OS_TOMEK_Model_Coef, rownames=FALSE)

##################################
# Computing the model predictions
##################################
(LR_OS_TOMEK_Model_Probabilities <- predict(LR_OS_TOMEK_Model, 
                              type = c("response")))
...
# based from the model predictions
##################################
(LR_OS_TOMEK_Model_Indices <- predict(LR_OS_TOMEK_Model, 
                           type = c("link")))
max(LR_OS_TOMEK_Model_Indices)
min(LR_OS_TOMEK_Model_Indices)
...
# based from the model predictions
##################################
LR_OS_TOMEK_Model_Predictions <- as.data.frame(PMA_PreModelling_Train_LR_OS_TOMEK)
LR_OS_TOMEK_Model_Predictions$LR_OS_TOMEK_Prob <- LR_OS_TOMEK_Model_Probabilities
LR_OS_TOMEK_Model_Predictions$LR_OS_TOMEK_LP <- LR_OS_TOMEK_Model_Indices
LR_OS_TOMEK_Model_Predictions$Class <- as.factor(LR_OS_TOMEK_Model_Predictions$Class)
LR_OS_TOMEK_Model_Predictions$Label <- rep("LR_OS_TOMEK",nrow(LR_OS_TOMEK_Model_Predictions))

##################################
# Formulating the probability curve
# using the consolidated model predictions
##################################
LR_OS_TOMEK_Model_Predictions %>%
  ggplot(aes(x = LR_OS_TOMEK_LP ,
             y = LR_OS_TOMEK_Prob,
             color = Class)) +
  scale_colour_manual(values=c("#1846BA55","#B8000055")) +
  geom_point(size=5) +
  ...
  scale_x_continuous( limits=c(-10,5), breaks=seq(-10,5,by=1)) +
  scale_y_continuous( limits=c(0,1), breaks=seq(0,1,by=0.1),labels = scales::percent) +
  ggtitle("Estimated Rock Object Detection Probabilities Based on Classification Index : Logistic Regression (OS_TOMEK)") +
  theme_bw() +
  theme(plot.title = element_text(color="black", size=14, face="bold", hjust=0.50),
        axis.title.x = element_text(color="black", size=12, face="bold"),
        axis.title.y = element_text(color="black", size=12, face="bold"),
